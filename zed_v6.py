...
def SEBASTIAN_VETTEL():
    ...
    return raw_image, label_and_distance, sign_coord, detected_objects, x_orta
...
park_test_pub = rospy.Publisher('yolo_park', String, queue_size=10)
...
while not rospy.is_shutdown():
    ...
    image, label_and_distance, sign_coord, detected_objects, x_orta = SEBASTIAN_VETTEL()
    ...
    park_test_pub.publish(str(x_orta))
